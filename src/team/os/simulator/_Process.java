...
public class _Process implements Comparable<Object> {
	...
	public _Process(String mPid, int mArrivalTime, int mBurstTime) {
	...
	public int compareTo(Object o) {
		...
		int time = arrivalTime - ((_Process) o).arrivalTime;
